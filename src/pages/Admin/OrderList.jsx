...
const OrderList = ({ orders, setOrders }) => {
  ...
  // 🧩 Load dữ liệu từ localStorage khi load lại trang
  useEffect(() => {
  ...
  // 🧠 Lưu lại orders mỗi khi thay đổi
  useEffect(() => {
    localStorage.setItem("orders", JSON.stringify(orders));
  }, [orders]);

  // 🧠 Lưu lại filter khi thay đổi
  useEffect(() => {
